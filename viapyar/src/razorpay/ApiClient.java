...
class ApiClient {
  ...
  <T extends Entity> T get(String path, JSONObject requestObject) throws RazorpayException, JSONException {
    Response response = ApiUtils.getRequest(path, requestObject, auth);
    return processResponse(response);
  }

  <T extends Entity> T post(String path, JSONObject requestObject) throws RazorpayException, JSONException {
    Response response = ApiUtils.postRequest(path, requestObject, auth);
    return processResponse(response);
  }

  <T extends Entity> T put(String path, JSONObject requestObject) throws RazorpayException, JSONException {
    Response response = ApiUtils.putRequest(path, requestObject, auth);
    return processResponse(response);
  }

  <T extends Entity> T patch(String path, JSONObject requestObject) throws RazorpayException, JSONException {
  ...
  private <T extends Entity> T parseResponse(JSONObject jsonObject) throws RazorpayException, JSONException {
  ...
  <T extends Entity> T processResponse(Response response) throws RazorpayException, JSONException {
    if (response == null) {
